...
Reads branching model and conventions from `.cursor/pai-orbit-config.md` → `## Git` section.

## MCP vs shell

Before executing any git or PR operation, check `.cursor/pai-orbit-config.md → ## MCP → git`:
