...
the analysis informed (or share in-session for quick checks). If the change has no feature folder
and does not warrant one — a dependency bump, a CI sweep — it is short-lived: write it to
