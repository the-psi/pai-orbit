...
1. Copy `{{DOCS_ROOT}}/decisions/_TEMPLATE.md` (or `{{DOCS_ROOT}}/decisions/ADR.md`)
2. Name it `{{DOCS_ROOT}}/decisions/YYYY-MM-DD-<slug>.md` (today's date + lowercase-hyphenated title, e.g. `2026-06-05-use-postgres-for-sessions.md`)
