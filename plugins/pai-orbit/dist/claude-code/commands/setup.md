...
Copy `templates/rules/decisions.md` to `.claude/rules/decisions.md`, replacing `{{DOCS_ROOT}}`.
...
Copy `templates/rules/docs-taxonomy.md` to `.claude/rules/docs-taxonomy.md`, replacing `{{DOCS_ROOT}}` throughout the routing table.
