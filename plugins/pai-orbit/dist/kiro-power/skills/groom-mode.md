---
name: groom-mode
description: pai-orbit groom mode - a feature requirements session. Output saved to `docs/features/<feature>/requirements.md`.
inclusion: manual
---
...
5. **Read context** — Now read relevant docs:
   ...
   - Read `CLAUDE.md`, existing `docs/features/`, and the parent epic from `docs/epics/` (if one exists)
