...
- Update `CLAUDE.md → ## Architecture` — replace placeholder Mermaid with actual flowchart, add one-paragraph summary, add reference: "Full declaration: [<target>/architecture/system.md](<target>/architecture/system.md)"
