---
name: review-mode
description: pai-orbit review mode - a code review session against the project's documented architecture, conventions, and requirements
inclusion: manual
---

# pai-orbit REVIEW Mode
...
## Usage in Kiro
Activate this mode by using `#review-mode` in your conversation or by typing "enter review mode".
