---
name: catchup-mode
description: pai-orbit catchup mode - a read-only session-start briefing: orient yourself in the project, report what moved recently, and propose what the developer should pick up next
inclusion: manual
---

# pai-orbit CATCHUP Mode
...
## Usage in Kiro
Activate this mode by using `#catchup-mode` in your conversation or by typing "enter catchup mode".
