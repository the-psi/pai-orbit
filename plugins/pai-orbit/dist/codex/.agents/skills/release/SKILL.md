---
name: "release"
description: "Coordinate a release. Use for release planning, cut list, changelog assembly, and deploy sequencing. Writes docs/plans/release-<version>.md. Explicit invocation only."
---
...
Reads deployment targets and commands from `.codex/pai-orbit-config.md` → `## Deploy` section.
...
Run the deployment commands from `.codex/pai-orbit-config.md` in the configured order.
