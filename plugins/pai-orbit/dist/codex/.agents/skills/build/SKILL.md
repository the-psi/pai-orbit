---
name: "build"
description: "Implement features and fixes. Use for coding sessions where requirements and design are already clear and it's time to write code. Writes code and updates docs/features/<feature>/. Explicit invocation only."
---
...
- Priority or sequencing is unclear → `$orbit-plan`
...
Before starting:
- **Branch (first action — before any file edit):** Read `.codex/pai-orbit-config.md → ## Git` to determine the branching model. Then:
